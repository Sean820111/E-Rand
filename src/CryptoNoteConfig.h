...
const uint64_t CRYPTONOTE_PUBLIC_ADDRESS_BASE58_PREFIX       = 0x21e2;
...
const char     CRYPTONOTE_NAME[]                             = "E-Rand";
...
const int      P2P_DEFAULT_PORT                              = 6886;
//TODO This port will be used by the daemon to interact with simlewallet
const int      RPC_DEFAULT_PORT                              = 2103;
